package com.evacipated.cardcrawl.modthespire.patching;
...
public class Patcher {
        ...
        throws IOException, NotFoundException, ClassNotFoundException
    {
        ...
        for (ModInfo modInfo : modInfos) {
            if (modInfo.MTS_Version.compareTo(com.evacipated.cardcrawl.modthespire.Loader.MTS_VERSION) <= 0) {
                AnnotationDB db;
        ...
        for (String class_name : sideloadList) {
            ...
            if (sideload != null) {
                for (String modid : sideload.modIDs()) {
                    if (!com.evacipated.cardcrawl.modthespire.Loader.isModLoaded(modid)) {
    ...
    public static List<Iterable<String>> findPatches(URL[] urls, ModInfo[] modInfos) throws IOException
    {
        ...
        for (int i = 0; i < urls.length; ++i) {
            if (modInfos == null || modInfos[i].MTS_Version.compareTo(com.evacipated.cardcrawl.modthespire.Loader.MTS_VERSION) <= 0) {
                AnnotationDB db;
    ...
    public static void finalizePatches(ClassLoader loader) throws Exception
    {
        ...
        if (com.evacipated.cardcrawl.modthespire.Loader.DEBUG) {
            System.out.println();
            System.out.println();
        }
    ...
    public static void injectPatches(ClassLoader loader, ClassPool pool, Iterable<String> class_names) throws Exception
    {
        ...
        for (String cls_name : class_names) {
            ...
            while (iter.hasNext()) {
                ...
                if (!modId.isEmpty() && Arrays.stream(com.evacipated.cardcrawl.modthespire.Loader.MODINFOS).noneMatch(x -> modId.equals(x.ID))) {
                    iter.remove();
                }
            }
    ...
    public static void patchOverrides(
        ClassLoader loader,
        ClassPool pool,
        ModInfo[] modInfos
